        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="admin_jobs.php">
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="admin_edit_job.php?id=<?= $job['id']; ?>" class="btn btn-sm btn-primary editFormButton" data-id="<?= $job['id']; ?>">Edit</a>
                                    <a href="admin_delete_job.php?id=<?= $job['id']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure you want to delete this job?')">Delete</a>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
